...
# 📖 [Free World Clock] <a name="about-project"></a>

**[Free World Clock]** is a user-friendly, interactive website that provides real-time updates on the current time and date for various major cities around the globe. The website is designed to be visually appealing, responsive, and easy to navigate, making it an ideal tool for anyone who needs to keep track of time zones worldwide, whether for business, travel, or personal interest.
...
- [Live Demo Link](https://shiraz342002.github.io/Free-World-Clock/)
...
Feel free to check the [issues page](https://github.com/shiraz342002/Free-World-Clock/pulls).
